...
const Footer = () => {
  return (
    <footer className="bg-white">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8 bg-blue-100">
        <div className="sm:flex sm:items-center sm:justify-between">
          <h2 className="font-bold text-2xl text-gray-700">Vehire</h2>
